 ...
 *
 */
/* Login->searching->adding the product to wishlist->adding the product to cart->reaching till payment option UPI->logout */
@Listeners(ListenerClass.class)
public class Amz_Smoke_07 extends LaunchandQuit
{
	@Test(dataProvider="LoginData",dataProviderClass=ExcelUtilities.class)
	public void smoke_testcase_07(String UN,String PWD) throws IOException, InterruptedException 
	{
