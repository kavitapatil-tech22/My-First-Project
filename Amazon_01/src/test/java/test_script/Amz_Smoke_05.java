 ...
 *
 */
/*  Login->searching->adding the product to wishlist->adding the product to cart->reaching till payment option CC->logout  */
@Listeners(ListenerClass.class)
public class Amz_Smoke_05 extends LaunchandQuit
{	
	@Test(dataProvider="LoginData",dataProviderClass=ExcelUtilities.class)	
	public void smoke_testcase_05(String UN,String PWD) throws IOException, InterruptedException 
	{
