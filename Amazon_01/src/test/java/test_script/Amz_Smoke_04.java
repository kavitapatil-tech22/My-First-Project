 ...
 */
/*
 * Login->searching->adding the product to wishlist->adding the product to cart->reaching till payment option COD->logout
 */
@Listeners(ListenerClass.class)
public class Amz_Smoke_04 extends LaunchandQuit
{
	@Test(dataProvider="LoginData",dataProviderClass=ExcelUtilities.class)
	public void smoke_testcase_04(String UN,String PWD) throws IOException, InterruptedException 
	{
